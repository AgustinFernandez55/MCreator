...
import net.mcreator.balizalandmod.procedures.TeclaAccesorioOnKeyPressedProcedure;
...
public class TeclaAccesorioKeyBinding extends BalizalandmodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public TeclaAccesorioKeyBinding(BalizalandmodModElements instance) {
		super(instance, 8);
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.tecla_accesorio", GLFW.GLFW_KEY_Y, "key.categories.ui");
		...
		if (type == 0) {
			{
				...
				TeclaAccesorioOnKeyPressedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
